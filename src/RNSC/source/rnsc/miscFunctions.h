...
void PrintStats(double Samples [], int NumSamples, const char * name);
void PrintStatsShort(int Samples [], int NumSamples, const char * name);
void PrintStatsShort(double Samples [], int NumSamples, const char * name);
double getTime();
